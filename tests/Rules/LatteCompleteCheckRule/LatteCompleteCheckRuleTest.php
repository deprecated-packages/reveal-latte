...
final class LatteCompleteCheckRuleTest extends AbstractServiceAwareRuleTestCase
{
    ...
    public function provideData(): Iterator
    {
        ...
        $multiActionsPresenterErrors = array_merge($this->createSharedErrorMessages(10), $this->createSharedErrorMessages(10), $this->createSharedErrorMessages(10));
    ...
    protected function getRule(): \Reveal\RevealLatte\Rules\LatteCompleteCheckRule
    {
